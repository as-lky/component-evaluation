...
commands1 = [
    ["python", "main.py", "--device", "cuda", "--taskname", "IS", "--instance_path", f"./Dataset/IS_fakeeasy_instance/IS_fakeeasy_instance/LP/IS_fakeeasy_instance_{i}.lp", "--graphencode", "test", "--predict", "gurobi", "--modify", "default", "--search", "gurobi", "--whole_time_limit", "1800"] for i in range(3)
]
commands2 = [
    ["python", "main.py", "--device", "cuda", "--taskname", "MIKSC", "--instance_path", f"./Dataset/MIKSC_fakeeasy_instance/MIKSC_fakeeasy_instance/LP/MIKSC_fakeeasy_instance_{i}.lp", "--graphencode", "test", "--predict", "gurobi", "--modify", "default", "--search", "gurobi", "--whole_time_limit", "1800"] for i in range(3)
]
commands3 = [
    ["python", "main.py", "--device", "cuda", "--taskname", "SC", "--instance_path", f"./Dataset/SC_fakeeasy_instance/SC_fakeeasy_instance/LP/SC_fakeeasy_instance_{i}.lp", "--graphencode", "test", "--predict", "gurobi", "--modify", "default", "--search", "gurobi", "--whole_time_limit", "1800"] for i in range(3)
]
commands4 = [
    ["python", "main.py", "--device", "cuda", "--taskname", "MVC", "--instance_path", f"./Dataset/MVC_fakeeasy_instance/MVC_fakeeasy_instance/LP/MVC_fakeeasy_instance_{i}.lp", "--graphencode", "test", "--predict", "gurobi", "--modify", "default", "--search", "gurobi", "--whole_time_limit", "1800"] for i in range(3)
]
...
#processes = [subprocess.Popen(cmd) for cmd in commands1 + commands2 + commands3 + commands4]
processes = [subprocess.Popen(cmd) for cmd in commands3 + commands4]
#processes = [subprocess.Popen(cmd) for cmd in commands2]
