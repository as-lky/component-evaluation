...
#    now = graphencode_component.work()
    ...
    # python main.py --device cuda:1 --taskname MT --instance_path ./Dataset/MT_medium_instance/MT_medium_instance/LP/MT_medium_instance_0.lp --graphencode default --predict gurobi --modify default --search gurobi --whole_time_limit 12000
    # python main.py --device cpu --taskname MVC --instance_path ./Dataset/MVC_hard_instance/MVC_hard_instance/LP/MVC_hard_instance_0.lp --graphencode bi --predict gcn --modify nr --search ACP --search_time_limit 3500 --search_ACP_LNS_block 5 --search_ACP_LNS_max_turn_ratio 0.8277884709369279
    # python main.py --device cuda --taskname IS --instance_path ./Dataset/IS_medium_instance/IS_medium_instance/LP/IS_medium_instance_0.lp --graphencode bir --predict gcn --modify nr --search gurobi --whole_time_limit 600
    # python main.py --device cuda --taskname SC --instance_path ./Dataset/SC_medium_instance/SC_medium_instance/LP/SC_medium_instance_0.lp --graphencode trir --predict gcn --modify np --search LNS --whole_time_limit 600
    # python main.py --device cuda --taskname MVC --instance_path ./Dataset/MVC_medium_instance/MVC_medium_instance/LP/MVC_medium_instance_5.lp --graphencode bir --predict gcn --modify nr --search gurobi --whole_time_limit 600
    # python main.py --device cuda --taskname MIKSC --instance_path ./Dataset/MIKSC_medium_instance/MIKSC_medium_instance/LP/MIKSC_medium_instance_0.lp --graphencode default --predict gurobi --modify default --search LIH --whole_time_limit 4000
    # python main.py --device cuda --taskname MIKSC --instance_path ./Dataset/MIKSC_medium_instance/MIKSC_medium_instance/LP/MIKSC_medium_instance_0.lp --graphencode default --predict gurobi --modify default --search LIH --whole_time_limit 4000 --search_LIH_MIH_NALNS_choose 0.659626430134522 --search_LIH_MIH_set_pa 0.25424632090514115
