...
if args.taskname == "IS":
    INSLIST = ["IS_easy_instance_0", "IS_easy_instance_1", "IS_fakeeasy_instance_2"]
if args.taskname == "SC":
    INSLIST = ["SC_easy_instance_0", "SC_fakeeasy_instance_1", "SC_fakeeasy_instance_2"]
if args.taskname == "MVC":
    INSLIST = ["MVC_easy_instance_0", "MVC_easy_instance_1", "MVC_fakeeasy_instance_2"]
if args.taskname == "MIKS":
    INSLIST = ["MIKS_easy_instance_0", "MIKS_easy_instance_1", "MIKS_fakeeasy_instance_2"]
if args.taskname == "MIKSC":
    INSLIST = ["MIKSC_easy_instance_0", "MIKSC_easy_instance_1", "MIKSC_fakeeasy_instance_2"]
if args.taskname == "MT":
    INSLIST = ["MT_easy_instance_0", "MT_easy_instance_1", "MT_fakeeasy_instance_2"]
